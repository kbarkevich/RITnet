...
def parse_args():
    ...
    parser.add_argument('--curObj', type=str, default='riteyes_general', help='select curriculum to train on')#, required=True)
#    parser.add_argument('--curObj', type=str, help='select curriculum to train on', required=True)
    parser.add_argument('--path2data', type=str, default='/media/aaa/hdd/ALL_model/', help='path to dataset')
